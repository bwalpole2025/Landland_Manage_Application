...
//
// Starts BullMQ workers for reminders, arrears detection and bank-feed polling,
// and registers repeatable schedules. Exits cleanly when REDIS_URL is not set so
// it is safe to run in any environment.

import "dotenv/config";
import { Worker } from "bullmq";
import { getConnection, QUEUE_NAMES } from "./queue";
